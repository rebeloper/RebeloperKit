 ...
 */
open class RKListHeaderController<T: RKListCell<U>, U, H: UICollectionReusableView>: UICollectionViewController {
    ...
    required public init?(coder aDecoder: NSCoder) {
        fatalError("You most likely have a Storyboard controller that uses this class, please remove any instance of RKListHeaderController or sublasses of this component from your Storyboard files.")
    }
